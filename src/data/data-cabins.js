// export const supabaseUrl = "https://fobpsrfobckzvloujtsa.supabase.co";
const imageUrl = `https://fobpsrfobckzvloujtsa.supabase.co/storage/v1/object/public/cabin-images/`;
